...
burgerimg = PhotoImage(file = cwd+"/img/burger.ppm") # init the img
burgerlabel = Label(root, image = burgerimg, relief = "solid").grid(row = 2, column = 1, columnspan = 3, rowspan = 3)
# up button
upimg = PhotoImage(file = cwd+"/img/up.ppm") # init the img
...
# down button
downimg = PhotoImage(file = cwd+"/img/down.ppm") # init the img
...
pizzaimg = PhotoImage(file = cwd+"/img/pizza.ppm") # init the img
pizzalabel = Label(root, image = pizzaimg, relief = "solid").grid(row = 6, column = 1, columnspan = 3, rowspan = 3)
# up button
upimg_pizza = PhotoImage(file = cwd+"/img/up.ppm") # init the img
...
# down button
downimg_pizza = PhotoImage(file = cwd+"/img/down.ppm") # init the img
...
friesimg = PhotoImage(file = cwd+"/img/fries.ppm") # init the img
frieslabel = Label(root, image = friesimg, relief = "solid").grid(row = 10, column = 1, columnspan = 3, rowspan = 3)
# up button
upimg_fries = PhotoImage(file = cwd+"/img/up.ppm") # init the img
...
# down button
downimg_fries = PhotoImage(file = cwd+"/img/down.ppm") # init the img
...
# down button
downimg_drink = PhotoImage(file = cwd+"/img/down.ppm")
